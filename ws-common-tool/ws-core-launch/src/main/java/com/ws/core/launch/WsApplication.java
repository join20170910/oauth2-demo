package com.ws.core.launch;

import com.ws.core.launch.constant.AppConstant;
import com.ws.core.launch.constant.NacosConstant;
import com.ws.core.launch.constant.SentinelConstant;
...
/**
 * @Author John
 * @Description //TODO 项目启动器，搞定环境变量问题
 * @Date 12:02 2020/8/23
 **/
...
public class WsApplication {
	...
	public static SpringApplicationBuilder createSpringApplicationBuilder(String appName, Class source, String... args) {
		...
		String startJarPath = WsApplication.class.getResource("/").getPath().split("!")[0];
		...
		props.setProperty("ws.env", profile);
		props.setProperty("ws.name", appName);
		props.setProperty("ws.is-local", String.valueOf(isLocalDev()));
		props.setProperty("ws.dev-mode", profile.equals(AppConstant.PROD_CODE) ? "false" : "true");
		props.setProperty("ws.service.version", AppConstant.APPLICATION_VERSION);
